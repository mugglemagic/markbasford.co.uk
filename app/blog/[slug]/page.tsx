...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const seriesPosts = post.frontmatter.series ? await getPostsBySeries(post.frontmatter.series) : []
      ...
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="lg:grid lg:grid-cols-[1fr_220px] lg:gap-10">
          <article>
            ...
            {/* Series navigation */}
            {seriesPosts.length > 1 && <SeriesNav currentPost={post} seriesPosts={seriesPosts} />}
          </article>
