...
![TODO: Apple-related image needed](/blog/apple-garage.webp)

On April 1, Apple turned fifty. The celebrations have been everywhere — the performances, the retrospectives, Tim Cook reflecting on five decades of thinking different. But the thing about Apple that keeps coming back to me isn't the founding story. Everyone knows the garage, the circuit boards, the two Steves. The interesting thing is how many times they've been willing to destroy what was working.

The Apple II was one of the most successful personal computers ever made. They built the Macintosh anyway. The Mac defined the company's identity for a decade. They pivoted to iPod and then iPhone, cannibalising their own product line in the process. The iPhone was generating billions with Intel inside. They ripped it out and designed their own silicon.

Every one of those transitions meant abandoning revenue, expertise, tooling, and comfort. Every one of them was the right call — not because what they had was broken, but because what they needed next couldn't be built on top of what they already had.

We've been thinking about that pattern quite a lot.

---

## The System That Works

We have a product that works. Customers use it daily. It handles millions of applications, processes complex workflows, and powers hiring for organisations of every size. We're not writing this because we escaped from something broken.
...
The realisation came gradually, over dog walks and too many coffees: if we structured things deliberately, AI could help us move faster. And if we were going to restructure anyway, why keep patching? Why not build the thing we actually needed?
...
Each post follows a simple pattern: here's the problem, here's what we considered, here's what we built, here's what we learned.
...
Jobs and Wozniak in that Los Altos garage couldn't have imagined Apple Park. They were selling circuit boards to hobbyists. But every version of Apple — the circuit board company, the Mac company, the iPod company, the iPhone company, the silicon company — was built by people willing to let go of the thing that was working in favour of the thing that was needed.

The Apple II wasn't failing when they built the Mac. The iPod wasn't failing when they built the iPhone. The Intel partnership wasn't failing when they designed M1. Each time, the existing thing worked fine for what it was. It just couldn't become what came next.
